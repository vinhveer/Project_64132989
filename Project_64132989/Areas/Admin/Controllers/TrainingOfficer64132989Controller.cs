...
namespace Project_64132989.Areas.Admin.Controllers
{
    ...
    public class TrainingOfficer64132989Controller : Controller
    {
        ...
        [HttpPost]
        public JsonResult GetEmployeeList(int offset, int limit, string search, string sort, string order)
        {
            var query = _context.Users
                .Where(u => u.user_type == 3)
                .Include(u => u.Profile)
                .AsQueryable();
